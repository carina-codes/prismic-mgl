...
interface SkaterDocumentData {
  ...
  /**
   * Photo field in *Skater*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: skater.photo
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
export interface ContentIndexSliceDefaultPrimary {
   ...
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  content_type: prismic.KeyTextField;

  /**
   * Items to Show field in *ContentIndex → Default → Primary*
   *
   * - **Field Type**: Number
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.default.primary.items_to_show
   * - **Documentation**: https://prismic.io/docs/field#number
   */
  items_to_show: prismic.NumberField;
}
...
export interface TextAndImageSliceDefaultPrimary {
   ...
   */
  theme: prismic.SelectField<"Black" | "Gray" | "White", "filled">;
...
export interface TextAndImageSliceImageOnLeftPrimary {
   ...
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  theme: prismic.SelectField<"Black" | "Gray" | "White">;
